<?php 
    ...
    foreach($_SESSION['shopping_cart'] as $store_id => $store_qty) {
        ...
        $name_store = $stores_row['store_name'];
        $total = $stores_row['store_price'] * $store_qty;

        $sale_sql = "INSERT INTO `sales` VALUES (null, '$client_id', '$store_id', '$dttm')";
        ...
        $bills_sql = "INSERT INTO `bills` (cilent_id, store_name, sale_id) VALUES ('$client_id', '$name_store', '$sale_id')";
    ...
    if($sql_query && $insurance_query && $bills_query) {
        ...
        echo "<script>alert('สั่งซื้อสินค้าล้มเหลว');window.location.href='../follow.php';</script>";
    }
